              ...
              <div className="row g-3">
                <div className="col-2 d-none d-sm-block">
                  <div className="d-flex flex-column gap-2 align-items-stretch" role="tablist" aria-label="Product image thumbnails">
                    {product.images.map((image, index) => (
                      ...
                      >
                        <Image src={image} alt={`Product image ${index + 1}`} width={80} height={80} className="rounded-3 w-100 h-auto" style={{ objectFit: 'cover' }} />
                      </button>
                    ))}
                  </div>
                </div>
                <div className="col-12 col-sm-10">
                  ...
                  >
                    ...
                    <button type="button" aria-label="Next image" className="gallery-nav-btn end-0" onClick={goNext} disabled={selectedImage === product.images.length - 1}>
                      ›
                    </button>
                  </div>
                </div>
